              ...
              <form role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Uni Code</label>
                    <input type="text" class="form-control" id="join_unicode" placeholder="Unicode">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Password</label>
                    <input type="password" class="form-control" id="join_password" placeholder="Password">
                  </div>
